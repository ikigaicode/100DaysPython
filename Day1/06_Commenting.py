# If I want a line of text to not be considered by the computer at all,
# all I have to do is add the hashtag sign #
# or pound sign
# in front of the text.
# and this turns it into a comment.

# Like this. Yes, THIS text. line 1, 2, 3, 4, 5 and 7.
